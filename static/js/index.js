...
function handleFileUpload() {
    ...
    if (file) {
      ...
      .then(data => {
    // Si la respuesta indica una redirección, realiza la redirección desde JavaScript
        if (data.redirect) {
        window.location.href = data.url;
        } else {
            // Puedes agregar aquí el código para manejar la respuesta del servidor (data)
